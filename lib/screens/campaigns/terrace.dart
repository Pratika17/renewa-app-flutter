...
class TerraceScreen extends StatelessWidget {
  final Campaign campaign;

  const TerraceScreen({super.key, required this.campaign});
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        const Text(
                            'Share your terrace farming and recieve amazing rewards!'),
                        const SizedBox(height: 8),
                        Row(
                          children: [
