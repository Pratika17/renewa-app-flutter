...
class MangroveQuestScreen extends StatefulWidget {
  const MangroveQuestScreen({super.key, required this.campaign, required this.questions, required this.options});
  final Campaign campaign;
  final List<String> questions;
  final List<List<String>> options;

  @override
  State<MangroveQuestScreen> createState() {
    return _MangroveQuestScreenState();
  }
}

class _MangroveQuestScreenState extends State<MangroveQuestScreen> {
