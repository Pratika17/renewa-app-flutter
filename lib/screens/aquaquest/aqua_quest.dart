...
import 'package:renewa/screens/upload_1.dart';

class AquaQuestScreen extends StatefulWidget {
  const AquaQuestScreen({super.key, required this.campaign, required this.collectionName});
  final Campaign campaign;
  final String collectionName; // Add collection name parameter
  
  @override
  State<AquaQuestScreen> createState() {
    return _AquaQuestScreenState();
  }
}

class _AquaQuestScreenState extends State<AquaQuestScreen> {
  late bool isJoined;
  late bool isJoining;
  User? currentUser;
  ...
  Future<void> joinQuest() async {
    ...
    try {
      ...
      Navigator.of(context).push(MaterialPageRoute(
        builder: (context) => UploadOneScreen(campaign: widget.campaign),
      ));
    }
  }
