...
class CollectionAchievementsScreen extends StatelessWidget {
  const CollectionAchievementsScreen({super.key});
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return FutureBuilder<String>(
                future:
                    _getLoggedInUserName(userId), // Fetch logged-in user name
